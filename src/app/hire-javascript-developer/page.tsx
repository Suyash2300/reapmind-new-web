...
/* ─── tech icon map ─────────────────────────────────────────────────
   Lucide doesn't have brand icons, so we pair each tech with the most
   semantically appropriate Lucide icon + a unique accent color.       */
const TECH_ICON_MAP: Record<string, { icon: React.ElementType; color: string }> = {
    'React JS': { icon: LayoutDashboard, color: '#61DAFB' },
    'Angular JS': { icon: Triangle, color: '#DD0031' },
    'Vue JS': { icon: Triangle, color: '#42b883' },
    'Next.js': { icon: Triangle, color: '#000000' },
    'Node.js': { icon: Server, color: '#539E43' },
    'Express.js': { icon: GitMerge, color: '#888888' },
    'Nest JS': { icon: Hexagon, color: '#E0234E' },
    'TensorFlow.js': { icon: Brain, color: '#FF6F00' },
    'Brain.js': { icon: Cpu, color: '#F5A623' },
    'AWS': { icon: Cloud, color: '#FF9900' },
    'Azure': { icon: Cloud, color: '#0089D6' },
    'GCP': { icon: Cloud, color: '#4285F4' },
    'CI CD': { icon: GitMerge, color: '#2088FF' },
    'SQL': { icon: Database, color: '#336791' },
    'NoSQL': { icon: Circle, color: '#13AA52' },
};
...
const heroBullets = [
    'Hire a team of your choice — front-end, back-end, or full-stack JavaScript expertise.',
    'Pre-screened JS talent aligned with your specific needs and time-zone.',
    'Code documentation, flexible contracts, and data security assurance guaranteed.',
    'ReapMind: connecting you with the top 1% of JavaScript talent in India.',
];

const whyUs = [
    { icon: Users, title: 'Hire a Team of Your Choice', description: 'Hand-pick developers for front-end, back-end, or full-stack roles from our curated JavaScript talent pool.' },
    ...
    { icon: Zap, title: 'Flexibility & Retention', description: 'Scale your JavaScript squad up or down based on your roadmap cycles with zero friction.' },
...
const techStack = [
    {
        ...
        items: ['React JS', 'Angular JS', 'Vue JS', 'Next.js'],
    },
    {
    ...
    },
    {
        ...
        items: ['TensorFlow.js', 'Brain.js'],
    },
    {
        label: 'Cloud & DevOps',
        items: ['AWS', 'Azure', 'GCP', 'CI CD'],
    },
    {
        label: 'Databases',
        items: ['SQL', 'NoSQL'],
...
const hiringModels = [
    {
        ...
        highlight: true,
        description: 'Deep integration and full daily focus on your JavaScript project.',
    },
    {
        title: 'Part Time',
        icon: Zap,
    ...
    },
    {
        ...
        highlight: false,
        description: 'Short-scope consultations, API debugging, or UI fixes with no lock-in.',
    },
];

const developerTiers = [
    {
        level: 'Junior JavaScript Developer',
        exp: '1–3 Years Experienced',
        priceRange: '$800 – $1,200',
    },
    {
        level: 'Mid Level JavaScript Developer',
        exp: '3–5 Years Experienced',
        priceRange: '$1,300 – $1,500',
    },
    {
        level: 'Senior JavaScript Developer',
...
const faqs = [
    {
        q: 'Why should I hire JavaScript developers from India?',
        a: "India has a vast pool of highly skilled and experienced JavaScript developers. By hiring from India, you gain access to top-tier talent at competitive rates, allowing you to optimize your development costs without compromising on quality.",
    },
    {
        q: 'What JavaScript frameworks and libraries are your developers proficient in?',
        a: "Our developers have expertise in a wide range of JavaScript technologies, including React, Angular, Vue.js, Node.js, Express.js, and more. We carefully assess each developer's skills to ensure we match you with the right expertise for your project.",
    },
    {
        q: 'How do you ensure project quality and communication?',
        a: 'Our rigorous quality assurance processes include code reviews, testing, and project management methodologies. We also prioritize clear and consistent communication, ensuring you\'re always informed about the progress of your project.',
    },
    {
        q: 'Can I scale my team up or down as needed?',
        a: 'Absolutely! We understand that project needs can evolve. We offer the flexibility to scale your team up or down as required, ensuring you have the right resources at every project stage.',
    },
    {
        q: 'What are the benefits of hiring JavaScript developers through your company?',
        a: 'Hiring through us offers several benefits, including access to pre-vetted talent, reduced hiring time and effort, competitive rates, flexible engagement models, and ongoing support throughout your project.',
    },
];
    ...
    return (
        ...
        >
            ...
            <span
                ...
                style={{ background: `${meta.color}1a` }}   /* 10 % opacity tint */
            >
...
/* ─── page ──────────────────────────────────────────────────────────── */
export default function HireJavaScriptDevelopersPage() {
    ...
    return (
        <div className="overflow-x-hidden">
            ...
            >
                ...
                <div className="relative container mx-auto px-6 lg:px-8 py-36 lg:py-44 grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        >
                            {['JavaScript Rockstars,', 'Ready to Roll with', 'ReapMind JS.'].map((line, i) => (
                                <motion.span
                                    key={line}
                                    className="block"
                                ...
                                >
                                    {i === 2
                                        ? <><span style={{ color: 'var(--brand-blue)' }}>ReapMind</span>{' JS.'}</>
                                        : line}
                                </motion.span>
                            ))}
                        </h1>
                        ...
                        >
                            Hiring JavaScript developers in India doesn&apos;t have to be a headache. ReapMind simplifies
                            the process with expert vetting and matching, led by our team of senior developers. We connect
                            you with pre-screened JS talent for both full-time and part-time roles.
                        </motion.p>
            ...
            {/* ══ HIRE FORM ════════════════════════════════════════════════ */}
            <HireAndroidForm devRole="JavaScript Developer" image="/images/python/python-developers.png" />
                ...
                <div className="container mx-auto px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-16 items-start">
                        <motion.div {...fadeLeft} className="lg:sticky lg:top-32">
                            ...
                            >
                                Hire JavaScript Talent with<br />Confidence through ReapMind
                            </h2>
                            <p className="text-lg leading-relaxed mb-8" style={{ color: 'var(--muted-foreground)' }}>
                                Finding the perfect JavaScript developer can feel like searching for a needle in a haystack.
                                ReapMind eliminates the frustration, connecting you with pre-screened JS talent that aligns
                                with your specific needs — whether front-end, back-end, or full-stack.
                            </p>
                            <div className="flex items-center gap-4 mb-8">
                                ...
                                <div>
                                    <p className="font-black text-sm" style={{ color: 'var(--heading)' }}>Full-Stack JavaScript Engineering</p>
                                    <p className="text-xs" style={{ color: 'var(--muted-foreground)' }}>
                                        React, Angular, Vue, Node.js, Next.js, NestJS, TensorFlow.js, and cloud deployments
                                    </p>
                                </div>
                            </div>
                            <div className="relative rounded-2xl overflow-hidden h-52">
                                <Image src="/images/company-workspace.png" alt="JavaScript development team" fill className="object-cover" />
                                <div
            ...
            <section className="py-20 md:py-32" style={{ background: 'var(--section-tint)' }}>
                <div className="container mx-auto px-6 lg:px-8">
                    <SectionHeading
                        ...
                        description="Our elite JavaScript engineers aren't just coders; they're architects of innovation. They build high-performance, user-centric solutions that are both robust and scalable."
                        className="mb-14"
                    />
            ...
            <section className="py-20 md:py-32 bg-background">
                <div className="container mx-auto px-6 lg:px-8">
                    <SectionHeading
                        badge="How It Works"
                        title="Hire JavaScript Developers in 4 Simple Steps"
                        description="Take a look at the simple & straightforward process to hire JavaScript developers from ReapMind Innovations."
                        className="mb-16"
                    />
                    <div className="grid lg:grid-cols-2 gap-16 items-center max-w-5xl mx-auto">
                        {/* image */}
                        <motion.div {...fadeLeft} className="relative rounded-3xl overflow-hidden h-96 lg:h-[480px]">
                            <Image src="/images/svc-mobile-2.jpg" alt="JavaScript Developers at ReapMind" fill className="object-cover" />
                            <div
                            ...
                            <div className="absolute top-6 left-6 flex items-center gap-3 px-4 py-3 rounded-2xl section-card">
                                ...
                                <span className="text-xs font-bold" style={{ color: 'var(--heading)' }}>
                                    Actively matching JavaScript developers
                                </span>
                            </div>
                            <div className="absolute bottom-6 left-6 right-6">
                                <div className="section-card rounded-2xl px-5 py-4 flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm font-black" style={{ color: 'var(--heading)' }}>Top 1% JavaScript Talent</p>
                                        <p className="text-xs" style={{ color: 'var(--muted-foreground)' }}>
                                            Vetted on frontend speed, React architecture, and API integration
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    >
                        ...
                        <div className="relative">
                            <h3 className="text-xl font-black mb-2" style={{ color: 'var(--heading)' }}>
                                Ready to turn your JavaScript project into a tangible success?
                            </h3>
                            <p className="text-sm" style={{ color: 'var(--muted-foreground)' }}>
                                ReapMind delivers qualified JavaScript developers to scale your operations immediately.
                            </p>
                        </div>
            ...
            <section id="models" className="py-20 md:py-32" style={{ background: 'var(--section-tint)' }}>
                <div className="container mx-auto px-6 lg:px-8">
                    <SectionHeading
                        ...
                        description="Build your dream JavaScript application on a budget. Our flexible engagement models ensure you get the expertise you need at a price that works for you."
                        className="mb-14"
                    />
            ...
            <section className="py-20 md:py-32 bg-background">
                <div className="container mx-auto px-6 lg:px-8">
                    <SectionHeading
                        ...
                        title="Scale Your Team with Top-Tier JavaScript Developers"
                        description="Get access to the top talent in the field by hiring our dedicated JavaScript developers."
                        className="mb-14"
                    />
                    <div className="grid sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            <section className="py-20 md:py-32 bg-background">
                <div className="container mx-auto px-6 lg:px-8">
                    <SectionHeading badge="Industries We Serve" title="JavaScript Apps Across Every Sector" className="mb-14" />
            ...
            <section className="py-20 md:py-32 bg-background">
                <div className="container mx-auto px-6 lg:px-8">
                    <SectionHeading
                        ...
                        description="Everything you need to know before hiring your JavaScript developer from ReapMind."
                        className="mb-14"
                    />
                ...
                <div className="relative container mx-auto px-6 lg:px-8 text-center">
                    <motion.div {...fadeUp}>
                        ...
                        <h2
                            ...
                            style={{ color: 'var(--heading)', letterSpacing: '-0.04em' }}
                        >
                            Ready to Hire Your<br />JavaScript Developer?
                        </h2>
                        <p className="text-lg mb-10 max-w-2xl mx-auto" style={{ color: 'var(--muted-foreground)' }}>
                            Hire dedicated JavaScript developers in India who are eager to collaborate and bring your vision
                            to life. We&apos;ll work closely with you, transforming your ideas into high-performing solutions
