...
import {
  ...
  Phone, Mail, MapPin, Server, Layers, RefreshCw,
  TrendingUp, Award,
} from 'lucide-react';
...
/* ─── data ────────────────────────────────────────────────────────── */
const heroStats = [
  { value: 1000, suffix: '+', label: 'Cloud Deployments' },
  { value: 16,   suffix: '+', label: 'Years Experience' },
  { value: 150,  suffix: '+', label: 'AWS Developers' },
  { value: 80,   suffix: '+', label: 'Certified Experts' },
];

const heroBullets = [
  'Build scalable, secure, and cost-effective cloud infrastructures with elite AWS engineers.',
  'Serverless architectures, custom VPC designs, and containerized deployments (EKS/ECS).',
  'Hire pre-vetted cloud specialists for full-time, part-time, or hourly engagements.',
  'ReapMind: Sourcing and onboarding top 1% AWS-certified developers in India.',
];

const whyUs = [
  { icon: Code,       title: 'Infrastructure as Code',  description: 'Well-structured, reusable terraform and CloudFormation templates documented for clean hands-off.' },
  ...
  { icon: Users,      title: 'Flexibility & Retention',  description: 'Scale your AWS cloud operations squad up or down based on your roadmap cycles.' },
  ...
  { icon: Star,       title: 'Top 1% Vetted Talent',     description: 'A 5-stage assessment covering cloud architecture, DevOps, cost management, and security.' },
];

const techStack = [
  { label: 'Compute',               items: ['EC2', 'Lambda', 'ECS', 'EKS'] },
  { label: 'Storage',               items: ['S3', 'EBS', 'EFS'] },
  { label: 'Database',              items: ['RDS', 'Dynamo DB', 'Aurora'] },
  { label: 'Network & Content',     items: ['VPC', 'Route 53', 'CloudFront'] },
  { label: 'Security & Management', items: ['IAM', 'KMS'] },
];
...
const hiringModels = [
  { title: 'Full Time',    icon: Clock,    hours: '8 hrs / day',    commitment: '160 hrs / month', highlight: true,  description: 'Deep integration and full daily focus on your AWS application infrastructure.' },
  { title: 'Part Time',    icon: Zap,      hours: '4 hrs / day',    commitment: '60 hrs / month',  highlight: false, description: 'Ongoing support, server migrations, or feature customization alongside your team.' },
  { title: 'Hourly Basis', icon: RefreshCw,hours: 'Open hrs / day', commitment: '50 hrs minimum',  highlight: false, description: 'Short-scope consultations, cloud audits, or DevOps pipeline debugs with no lock-in.' },
];

const developerTiers = [
  { level: 'Junior AWS Developer',    exp: '1–3 Years Experienced', priceRange: '$1,000 – $1,500' },
  { level: 'Mid Level AWS Developer', exp: '3–5 Years Experienced', priceRange: '$1,600 – $2,200' },
  { level: 'Senior AWS Developer',    exp: '5+ Years Experienced',  priceRange: '$2,300 – $3,500' },
];

const relatedHires = [
  { title: 'Hire Full Stack Developers', description: 'Certified engineers writing scalable frontend interfaces and backend nodes.', href: '/hire-full-stack-developers' },
  ...
  { title: 'Hire Android Developers',    description: 'Expert mobile developers crafting polished client-side native apps.', href: '/hire-android-developers' },
];

const faqs = [
  { q: "What types of AWS projects can your developers handle?", a: "Our AWS developers have a wide range of expertise and can handle various projects, including Cloud migration (moving your apps and databases), Serverless development (creating scalable Lambda functions), DevOps implementation (setting up CI/CD pipelines), Security compliance (ensuring HIPAA, GDPR, or PCI DSS standards), and Database design." },
  { q: "How do you ensure the quality of your AWS developers?", a: "We have a rigorous vetting process. This includes technical assessments with coding challenges, verification of official AWS certifications (Solutions Architect, SysOps, Developer Associate), checking project experience in scalable clouds, and testing their communication skills." },
  { q: "How can I get started with hiring AWS developers from ReapMind?", a: "Getting started is easy! Simply reach out to us through our contact form. We'll discuss your requirements, recommend the best developers for your needs within 48 hours, and guide you through the onboarding process." },
  { q: "Do your AWS developers have experience with specific industries?", a: "Yes, our developers have experience working with clients in healthcare, e-commerce, finance, and logistics, and are familiar with security audits, compliance, and multi-zone backup strategies." },
];
...
export default function HireAWSDevelopersPage() {
  ...
  return (
    <div className="overflow-x-hidden">
        ...
        <div className="relative container mx-auto px-6 lg:px-8 py-36 lg:py-44 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h1 className="text-5xl md:text-6xl lg:text-[4.25rem] font-black leading-[1.02] mb-7"
              ...
              {['AWS Cloud Experts,', 'Ready to Roll with', 'ReapMind.'].map((word, i) => (
                <motion.span key={word} className="block"
                  initial={{ opacity: 0, x: -32 }} animate={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.55, delay: 0.1 + i * 0.12, ease: [0.22, 1, 0.36, 1] }}>
                  {i === 2 ? <><span style={{ color: 'var(--brand-blue)' }}>ReapMind</span>{' AWS.'}</> : word}
                </motion.span>
              ))}
            </h1>
            ...
            <motion.p className="text-[1.05rem] leading-[1.75] mb-8 max-w-lg"
              ...
              Level up your cloud operations and secure your applications with top AWS certified engineers. Scale seamlessly and reduce infrastructure overhead with elite DevOps talent.
            </motion.p>
      ...
      {/* ══ HIRE FORM ════════════════════════════════════════════════ */}
      <HireAndroidForm devRole="AWS Developer" image="/images/aws/aws-developers.png" />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <motion.div {...fadeLeft} className="lg:sticky lg:top-32">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-black leading-tight mb-6"
                ...
                Get Your AWS Project in<br />Expert Hands
              </h2>
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <p className="font-black text-sm" style={{ color: 'var(--heading)' }}>Advanced Cloud DevOps</p>
                  <p className="text-xs" style={{ color: 'var(--muted-foreground)' }}>CI/CD pipelines, Kubernetes container orchestrations, and automated auto-scaling backups</p>
                </div>
              </div>
              <div className="relative rounded-2xl overflow-hidden h-52">
                <Image src="/images/company-workspace.png" alt="AWS Cloud engineering team" fill className="object-cover" />
      ...
      <section className="py-20 md:py-32" style={{ background: 'var(--section-tint)' }}>
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading
            ...
            description="Harness the power of AWS by hiring cloud-savvy AWS developers from ReapMind. Our team is at the forefront of cloud innovation, leveraging the latest AWS services."
            className="mb-14"
          />
              ...
              <div key={cat.label}>
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  {cat.items.map((tech, ti) => {
                    ...
                    const imgSrc = `/images/aws/${imgName}`;
                    return (
                      <motion.div key={tech}
      ...
      <section className="py-20 md:py-32 bg-background">
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading
            badge="How It Works"
            title="Hire AWS Developers in 4 Simple Steps"
            description="Take a look at the simple & straightforward process to hire AWS developers from ReapMind Innovations."
            className="mb-16"
          />
          <div className="grid lg:grid-cols-2 gap-16 items-center max-w-5xl mx-auto">
            {/* image with floating badge */}
            <motion.div {...fadeLeft} className="relative rounded-3xl overflow-hidden h-96 lg:h-[480px]">
              <Image src="/images/svc-mobile-2.jpg" alt="AWS Developers at ReapMind" fill className="object-cover" />
              ...
              <div className="absolute top-6 left-6 flex items-center gap-3 px-4 py-3 rounded-2xl section-card">
                ...
                <span className="text-xs font-bold" style={{ color: 'var(--heading)' }}>Actively matching AWS developers</span>
              </div>
              <div className="absolute bottom-6 left-6 right-6">
                <div className="section-card rounded-2xl px-5 py-4 flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-black" style={{ color: 'var(--heading)' }}>Top 1% AWS Talent</p>
                    <p className="text-xs" style={{ color: 'var(--muted-foreground)' }}>Vetted on cloud security, DevOps automation, cost optimization, and databases</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <motion.div {...fadeUp}
            ...
            <div className="relative">
              <h3 className="text-xl font-black mb-2" style={{ color: 'var(--heading)' }}>
                Want to build high-performance AWS systems?
              </h3>
              <p className="text-sm" style={{ color: 'var(--muted-foreground)' }}>
                ReapMind delivers qualified AWS cloud developers to scale your operations immediately.
              </p>
            </div>
      ...
      <section id="models" className="py-20 md:py-32" style={{ background: 'var(--section-tint)' }}>
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading
            ...
            description="Scale your AWS operations on a budget. Our flexible engagement models ensure you get the expertise you need at a price that works for you."
            className="mb-14"
          />
      ...
      <section className="py-20 md:py-32 bg-background">
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading
            ...
            title="Scale Your Team with Top-Tier AWS Developers"
            description="ReapMind's expert AWS developers accelerate your infrastructure deployment timelines without compromising security."
            className="mb-14"
          />
          <div className="grid sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
      ...
      <section className="py-20 md:py-32 bg-background">
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading badge="Industries We Serve" title="AWS Solutions Across Every Sector" className="mb-14" />
      ...
      <section className="py-20 md:py-32" style={{ background: 'var(--section-tint)' }}>
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading badge="FAQ" title="Frequently Asked Questions"
            description="Everything you need to know before hiring your AWS developer from ReapMind."
            className="mb-14" />
        ...
        <div className="relative container mx-auto px-6 lg:px-8 text-center">
          <motion.div {...fadeUp}>
            ...
            <h2 className="text-3xl md:text-5xl font-black leading-tight mb-6"
              style={{ color: 'var(--heading)', letterSpacing: '-0.04em' }}>
              Ready to Hire Your<br />AWS Cloud Developer?
            </h2>
            <p className="text-lg mb-10 max-w-2xl mx-auto" style={{ color: 'var(--muted-foreground)' }}>
              Share your project requirements today. We&apos;ll match you with pre-vetted AWS developer profiles within 48 hours.
            </p>
