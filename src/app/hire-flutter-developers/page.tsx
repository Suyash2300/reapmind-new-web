...
const heroBullets = [
  '80+ cross-platform apps launched — iOS & Android from one codebase.',
  '98% client satisfaction — unwavering commitment to exceeding expectations.',
  'Top 1% Flutter talent — rigorously vetted Dart engineers.',
  '24/7 support — always available to keep your project on track.',
];

const whyUs = [
  { icon: Code,       title: 'Code Documentation',      description: 'Every widget, provider, and BLoC is thoroughly documented — making handovers seamless and future iterations fast.' },
  { icon: Globe,      title: 'Time-Zone Compatibility',  description: 'Teams in India, USA, and UAE align with your working hours so collaboration never misses a beat.' },
  { icon: Users,      title: 'Flexibility & Retention',  description: 'Scale your Flutter squad up or down on demand. Our contracts flex to match your project phase.' },
  { icon: Shield,     title: 'Flexible Contracts',       description: 'Hourly, part-time, or full-time — structured to fit your budget and risk profile perfectly.' },
  { icon: Zap,        title: 'Data Security Assurance',  description: 'NDAs, secure dev environments, and OWASP mobile best practices protect your IP throughout.' },
  { icon: Star,       title: 'Top 1% Talent',            description: 'A rigorous 5-stage vetting covers Dart depth, widget architecture, state management, and delivery track record.' },
];

const techStack = [
  { label: 'Core',           items: ['Dart', 'Flutter SDK', 'Flutter UI'] },
  { label: 'State Mgmt',     items: ['BLoC', 'Riverpod', 'Provider', 'GetX'] },
  { label: 'Backend & APIs', items: ['Firebase', 'RESTful APIs', 'GraphQL'] },
  { label: 'Cloud',          items: ['AWS', 'Azure', 'Google Cloud Platform'] },
  { label: 'Data',           items: ['SQL', 'NoSQL', 'Hive', 'Isar'] },
  { label: 'DevOps',         items: ['Git', 'GitHub Actions', 'Fastlane', 'CI/CD'] },
  { label: 'Architecture',   items: ['Clean Architecture', 'MVVM', 'Repository Pattern'] },
];

const hiringSteps = [
  { num: '01', title: 'Share Requirements',  icon: Users,      description: 'Tell us your project goals, desired Dart/Flutter skills, and timeline. We map to the right profiles.' },
  { num: '02', title: 'Review Profiles',     icon: Award,      description: 'Receive a curated shortlist of pre-vetted Flutter developers within 48 hours, matched on skills and culture.' },
  { num: '03', title: 'Interview & Select',  icon: CheckCircle2, description: 'Conduct technical interviews and culture-fit assessments until you find your perfect match.' },
  { num: '04', title: 'Onboard & Build',     icon: Layers,     description: 'Sign off and your dedicated Flutter developer integrates with your team and ships from day one.' },
];

const hiringModels = [
  { title: 'Full Time',    icon: Clock,    hours: '8 hrs / day',    commitment: '160 hrs / month', highlight: true,  description: 'Deep integration and full daily focus on your Flutter product.' },
  { title: 'Part Time',    icon: Zap,      hours: '4 hrs / day',    commitment: '60 hrs / month',  highlight: false, description: 'Ongoing support or feature additions alongside your existing team.' },
  { title: 'Hourly Basis', icon: RefreshCw,hours: 'Open hrs / day', commitment: '50 hrs minimum',  highlight: false, description: 'Short-scope work, audits, or consultations with no lock-in.' },
];

const developerTiers = [
  { level: 'Junior Flutter Developer',    exp: '1–3 Years Experienced', priceRange: '$800 – $1,200' },
  { level: 'Mid Level Flutter Developer', exp: '3–5 Years Experienced', priceRange: '$1,300 – $1,800' },
  { level: 'Senior Flutter Developer',    exp: '5+ Years Experienced',  priceRange: '$1,900 – $2,500' },
];

const relatedHires = [
  { title: 'Hire Android Developers',       description: 'Native Android engineers — Kotlin, Jetpack Compose, and the full Android ecosystem.', href: '/hire-top-android-developers' },
  ...
  { title: 'Hire React Native Developers',  description: 'Cross-platform engineers building fast, user-appealing mobile applications.', href: '/contact-us' },
];

const faqs = [
  { q: "Why should I hire Flutter developers from ReapMind?", a: "Our Flutter engineers are hand-picked through a 5-stage process. They've shipped real cross-platform apps to both the App Store and Google Play — with proven performance benchmarks, clean architecture, and measurable business outcomes. You get top 1% talent, a dedicated account manager, and a replace guarantee." },
  { q: "What level of expertise can I expect from ReapMind's Flutter developers?", a: "We offer Junior (1–3 yrs), Mid Level (3–5 yrs), and Senior (5+ yrs) Flutter developers. All levels have passed rigorous Dart, architecture, and delivery vetting. Senior developers bring deep BLoC/Riverpod expertise, CI/CD experience, and a track record of leading Flutter squads." },
  { q: "How does ReapMind ensure project transparency and communication?", a: "Every engagement includes daily standups, weekly sprint reviews, and a shared project board (Jira, Linear, or your preferred tool). A dedicated account manager is your single point of contact throughout the engagement." },
  { q: "Can ReapMind assist with app design and UI/UX?", a: "Yes — we offer full-service Flutter engagements including UI/UX design, custom widget development, animations, and design system implementation. Our designers work closely with Flutter developers to ensure pixel-perfect implementation of every screen." },
  { q: "What about app testing and deployment support?", a: "All deliverables include unit tests, widget tests, and integration test suites. We handle TestFlight and Play Console setup, app signing, and CI/CD pipelines via GitHub Actions or Fastlane so every release is automated and reliable." },
  { q: "How can I initiate the process of hiring Flutter developers from ReapMind?", a: "Fill in the hire form on this page with your requirements — or simply call us. We respond within 24 hours with matched developer profiles. Most clients have a Flutter developer contributing within 5–7 business days." },
];
...
export default function HireFlutterDevelopersPage() {
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      {/* ══ HERO — floating orbs + staggered word reveal ══════════════ */}
      <section className="relative min-h-screen flex items-center overflow-hidden"
        ...
        <div className="relative container mx-auto px-6 lg:px-8 py-36 lg:py-44 grid lg:grid-cols-2 gap-16 items-center">
          {/* left copy — words slide up in sequence */}
          <div>
            ...
            <motion.p className="text-[1.05rem] leading-[1.75] mb-8 max-w-lg"
              ...
              Stop searching for coders, start finding solutions. ReapMind&apos;s Flutter developers are passionate problem-solvers who delve deep into your project and craft cross-platform apps that exceed expectations.
            </motion.p>
          ...
          {/* right — stat cards with spring pop-in */}
      ...
      <HireAndroidForm devRole="Flutter Developer" image="/images/svc-mobile-2.jpg" />

      {/* ══ WHY US — cards slide in from alternating sides ═══════════ */}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <motion.div {...fadeLeft} className="lg:sticky lg:top-32">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-black leading-tight mb-6"
                ...
                Passion Meets Skill:<br />Hire Skilled Flutter<br />Developers
              </h2>
              <p className="text-lg leading-relaxed mb-8" style={{ color: 'var(--muted-foreground)' }}>
                Our Flutter engineers don&apos;t just write code — they become true partners. We champion collaboration, open communication, and a shared passion for creating user-centric solutions.
              </p>
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <p className="font-black text-sm" style={{ color: 'var(--heading)' }}>Cross-platform. One codebase.</p>
                  <p className="text-xs" style={{ color: 'var(--muted-foreground)' }}>iOS + Android from a single Flutter project</p>
                </div>
              </div>
              <div className="relative rounded-2xl overflow-hidden h-52">
                <Image src="/images/company-workspace.png" alt="Flutter dev team" fill className="object-cover" />
      ...
      {/* ══ TECH STACK — animated pill wave ══════════════════════════ */}
      <section className="py-20 md:py-32" style={{ background: 'var(--section-tint)' }}>
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading
            badge="Technologies"
            title="Cutting-Edge Flutter Technologies"
            description="We believe building exceptional apps is a team sport. Our elite Flutter engineers become true partners — championing collaboration, open communication, and user-centric solutions."
            className="mb-14"
          />
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  {cat.items.map((tech, ti) => (
                    <motion.span key={tech}
                      ...
                      className="px-4 py-2 rounded-full text-xs font-semibold section-card cursor-default"
                      style={{ color: 'var(--muted-foreground)' }}>
                      {tech}
                    </motion.span>
                  ))}
      ...
      {/* ══ HIRING PROCESS — left image + staggered step cards ═══════ */}
      <section className="py-20 md:py-32 bg-background">
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading
            badge="How It Works"
            title="Hire Flutter Developers in 4 Simple Steps"
            description="A transparent, fast process — most clients have a developer contributing within a week."
            className="mb-16"
          />
          <div className="grid lg:grid-cols-2 gap-16 items-center max-w-5xl mx-auto">
            {/* image with floating badge */}
            <motion.div {...fadeLeft} className="relative rounded-3xl overflow-hidden h-96 lg:h-[480px]">
              <Image src="/images/svc-mobile-2.jpg" alt="Flutter Developers at ReapMind" fill className="object-cover" />
              ...
              <div className="absolute top-6 left-6 flex items-center gap-3 px-4 py-3 rounded-2xl section-card">
                ...
                <span className="text-xs font-bold" style={{ color: 'var(--heading)' }}>Actively matching developers</span>
              </div>
              <div className="absolute bottom-6 left-6 right-6">
                <div className="section-card rounded-2xl px-5 py-4 flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-black" style={{ color: 'var(--heading)' }}>Top 1% Flutter Talent</p>
                    <p className="text-xs" style={{ color: 'var(--muted-foreground)' }}>5-stage technical vetting</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <motion.div {...fadeUp}
            ...
            <div className="relative">
              <h3 className="text-xl font-black mb-2" style={{ color: 'var(--heading)' }}>
                Want to build high-performance, beautiful Flutter apps?
              </h3>
              <p className="text-sm" style={{ color: 'var(--muted-foreground)' }}>
                ReapMind delivers exceptional quality — stunning, user-friendly apps that exceed your expectations.
              </p>
            </div>
      ...
      {/* ══ HIRING MODELS — cards with hover lift ════════════════════ */}
      <section id="models" className="py-20 md:py-32" style={{ background: 'var(--section-tint)' }}>
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading
            badge="Engagement Models"
            title="Our Flexible Hiring Models"
            description="Build your Flutter application on a budget. Our engagement models ensure you get the right expertise at a price that works for you."
            className="mb-14"
          />
      ...
      {/* ══ DEVELOPER TIERS — 3D flip cards ══════════════════════════ */}
      <section className="py-20 md:py-32 bg-background">
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading
            badge="Top 1% of Indian Developers"
            title="Scale Your Team with Top-Tier Flutter Developers"
            description="ReapMind's expert Flutter developers accelerate your development timeline without compromising quality."
            className="mb-14"
          />
          <div className="grid sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
      ...
      <section className="py-20 md:py-32" style={{ background: 'var(--section-tint)' }}>
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading badge="Also Hire" title="Explore More Talent"
            description="Beyond Flutter — access our full bench of vetted mobile engineers."
            className="mb-12" />
      ...
      <section className="py-20 md:py-32 bg-background">
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading badge="Industries We Serve" title="Flutter Apps Across Every Sector" className="mb-14" />
      ...
      <section className="py-20 md:py-32" style={{ background: 'var(--section-tint)' }}>
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading badge="FAQ" title="Frequently Asked Questions"
            description="Everything you need to know before hiring your Flutter developer from ReapMind."
            className="mb-14" />
        ...
        <div className="relative container mx-auto px-6 lg:px-8 text-center">
          <motion.div {...fadeUp}>
            ...
            <h2 className="text-3xl md:text-5xl font-black leading-tight mb-6"
              style={{ color: 'var(--heading)', letterSpacing: '-0.04em' }}>
              Ready to Hire Your<br />Flutter Developer?
            </h2>
            <p className="text-lg mb-10 max-w-2xl mx-auto" style={{ color: 'var(--muted-foreground)' }}>
              Share your requirements today. We&apos;ll send you matched, pre-vetted Flutter developer profiles within 48 hours.
            </p>
