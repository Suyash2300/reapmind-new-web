...
const heroStats = [
  ...
  { value: 180,  suffix: '+', label: 'Swift Developers' },
  { value: 75,   suffix: '+', label: 'Apple Certified Experts' },
];

const heroBullets = [
  'Build sleek, high-performing iOS apps with elite Swift developers.',
  'Native performance, custom SwiftUI layouts, and reactive data streams using Combine.',
  'Hire pre-vetted engineers for full-time, part-time, or hourly contracts.',
  'ReapMind: Sourcing and onboarding top 1% Swift talent in India.',
];
...
const whyUs = [
  ...
  { icon: Users,      title: 'Flexibility & Retention',  description: 'Scale your Swift engineering squad up or down based on your roadmap cycles.' },
  ...
  { icon: Star,       title: 'Top 1% Vetted Talent',     description: 'A 5-stage assessment covering SwiftUI, MVC/MVVM patterns, CoreData, and memory profiling.' },
];

const techStack = [
  { label: 'Core / Language',     items: ['Swift', 'Objective-C'] },
  { label: 'Layout & Framework',  items: ['SwiftUI', 'UI Kit'] },
  { label: 'Tools & Ecosystem',   items: ['Xcode', 'Test Flight', 'App Store'] },
  { label: 'Storage & Sync',      items: ['Core Data', 'CloudKit'] },
  { label: 'Advanced SDKs',       items: ['ARKit', 'Core ML', 'Swift Combine'] },
];
...
const hiringModels = [
  { title: 'Full Time',    icon: Clock,    hours: '8 hrs / day',    commitment: '160 hrs / month', highlight: true,  description: 'Deep integration and full daily focus on your native iOS application.' },
  { title: 'Part Time',    icon: Zap,      hours: '4 hrs / day',    commitment: '60 hrs / month',  highlight: false, description: 'Ongoing support, SDK upgrades, or feature customization alongside your team.' },
  { title: 'Hourly Basis', icon: RefreshCw,hours: 'Open hrs / day', commitment: '50 hrs minimum',  highlight: false, description: 'Short-scope consultations, App Store submission support, or memory leak audits.' },
];

const developerTiers = [
  { level: 'Junior Swift Developer',    exp: '1–3 Years Experienced', priceRange: '$1,000 – $1,400' },
  { level: 'Mid Level Swift Developer', exp: '3–5 Years Experienced', priceRange: '$1,500 – $2,000' },
  { level: 'Senior Swift Developer',    exp: '5+ Years Experienced',  priceRange: '$2,100 – $3,000' },
];

const relatedHires = [
  { title: 'Hire iOS Developers',      description: 'Elite Apple platform specialists using both Objective-C and Swift.', href: '/hire-the-best-ios-developers' },
...
const faqs = [
  { q: "What experience do ReapMind's Swift developers have?", a: "Our Swift developers are seasoned professionals with a proven track record of building high-quality iOS apps. They possess deep expertise in Swift, Apple's frameworks (SwiftUI, Combine, ARKit, Core Data, Core ML), and Apple App Store guidelines." },
  { q: "How does the hiring process work?", a: "We make it easy. Tell us about your project requirements. We'll present you with a curated selection of matching developers within 48 hours. You can interview them, check their portfolios, and choose the best fit." },
  { q: "What kind of support does ReapMind provide after the app launch?", a: "We offer ongoing support and maintenance services. This includes prompt bug fixes, performance optimizations, feature enhancements, and preparing/submitting updates to the iOS App Store." },
  { q: "What is the estimated cost of hiring Swift developers from ReapMind?", a: "The cost depends on project scope, complexity, developer seniority, and engagement model (dedicated full-time, part-time, or hourly). We offer highly competitive pricing structures." },
];
...
/* ─── page ───────────────────────────────────────────────────────── */
export default function HireSwiftDevelopersPage() {
  ...
  return (
    <div className="overflow-x-hidden">
        ...
        <div className="relative container mx-auto px-6 lg:px-8 py-36 lg:py-44 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h1 className="text-5xl md:text-6xl lg:text-[4.25rem] font-black leading-[1.02] mb-7"
              ...
              {['Sleek iOS Apps,', 'Ready to Roll with', 'ReapMind.'].map((word, i) => (
                <motion.span key={word} className="block"
                  initial={{ opacity: 0, x: -32 }} animate={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.55, delay: 0.1 + i * 0.12, ease: [0.22, 1, 0.36, 1] }}>
                  {i === 2 ? <><span style={{ color: 'var(--brand-blue)' }}>ReapMind</span>{' Swift.'}</> : word}
                </motion.span>
              ))}
            </h1>
            ...
            <motion.p className="text-[1.05rem] leading-[1.75] mb-8 max-w-lg"
              ...
              What if your iOS app could be as sleek and powerful as the iPhone? ReapMind&apos;s Swift developers for hire in India make that happen by harnessing Apple&apos;s frameworks.
            </motion.p>
      ...
      {/* ══ HIRE FORM ════════════════════════════════════════════════ */}
      <HireAndroidForm devRole="Swift Developer" image="/images/swift/swift-developers.png" />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <motion.div {...fadeLeft} className="lg:sticky lg:top-32">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-black leading-tight mb-6"
                ...
                Swift Developers, Ready to<br />Roll with ReapMind
              </h2>
              <p className="text-lg leading-relaxed mb-8" style={{ color: 'var(--muted-foreground)' }}>
                Our Swift developers are experts at harnessing the latest Apple technologies to build apps that are not only beautiful but also lightning-fast, secure, and ready to scale. Reach for absolute visual and functional quality on iOS.
              </p>
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <p className="font-black text-sm" style={{ color: 'var(--heading)' }}>Modern iOS Engineering</p>
                  <p className="text-xs" style={{ color: 'var(--muted-foreground)' }}>Polished UI transitions, reactive components, memory safety, and seamless CoreData storage</p>
                </div>
              </div>
              <div className="relative rounded-2xl overflow-hidden h-52">
                <Image src="/images/company-workspace.png" alt="Swift iOS engineering team" fill className="object-cover" />
      ...
      <section className="py-20 md:py-32" style={{ background: 'var(--section-tint)' }}>
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading
            ...
            description="Our Swift developers build dynamic interfaces using SwiftUI, reactive Combine pipelines, and secure local databases."
            className="mb-14"
          />
              ...
              <div key={cat.label}>
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  {cat.items.map((tech, ti) => {
                    ...
                    const cleanedName = imgName.replace('swift-combine.png', 'swift-combine.png'); // matching direct download
                    const hasIcon = AVAILABLE_ICONS.includes(cleanedName);
                    const imgSrc = `/images/swift/${cleanedName}`;
                    return (
                      <motion.div key={tech}
      ...
      <section className="py-20 md:py-32 bg-background">
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading
            badge="How It Works"
            title="Hire Swift Developers in 4 Simple Steps"
            description="Take a look at the simple & straightforward process to hire Swift developers from ReapMind Innovations."
            className="mb-16"
          />
          <div className="grid lg:grid-cols-2 gap-16 items-center max-w-5xl mx-auto">
            {/* image with floating badge */}
            <motion.div {...fadeLeft} className="relative rounded-3xl overflow-hidden h-96 lg:h-[480px]">
              <Image src="/images/svc-mobile-2.jpg" alt="Swift Developers at ReapMind" fill className="object-cover" />
              ...
              <div className="absolute top-6 left-6 flex items-center gap-3 px-4 py-3 rounded-2xl section-card">
                ...
                <span className="text-xs font-bold" style={{ color: 'var(--heading)' }}>Actively matching Swift developers</span>
              </div>
              <div className="absolute bottom-6 left-6 right-6">
                <div className="section-card rounded-2xl px-5 py-4 flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-black" style={{ color: 'var(--heading)' }}>Top 1% Swift Talent</p>
                    <p className="text-xs" style={{ color: 'var(--muted-foreground)' }}>Vetted on memory safety, MVC/MVVM patterns, CoreData, and SwiftUI components</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <motion.div {...fadeUp}
            ...
            <div className="relative">
              <h3 className="text-xl font-black mb-2" style={{ color: 'var(--heading)' }}>
                Want to build high-performance Swift application?
              </h3>
              <p className="text-sm" style={{ color: 'var(--muted-foreground)' }}>
                ReapMind delivers qualified Swift developers to scale your iOS capabilities immediately.
              </p>
            </div>
      ...
      <section id="models" className="py-20 md:py-32" style={{ background: 'var(--section-tint)' }}>
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading
            ...
            description="Build your dream Swift application on a budget. Our flexible engagement models ensure you get the expertise you need at a price that works for you."
            className="mb-14"
          />
      ...
      <section className="py-20 md:py-32 bg-background">
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading
            ...
            title="Scale Your Team with Top-Tier Swift Developers"
            description="ReapMind's expert Swift developers accelerate your iOS development timelines without compromising quality."
            className="mb-14"
          />
          <div className="grid sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
      ...
      <section className="py-20 md:py-32 bg-background">
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading badge="Industries We Serve" title="Swift Apps Across Every Sector" className="mb-14" />
      ...
      <section className="py-20 md:py-32" style={{ background: 'var(--section-tint)' }}>
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading badge="FAQ" title="Frequently Asked Questions"
            description="Everything you need to know before hiring your Swift developer from ReapMind."
            className="mb-14" />
        ...
        <div className="relative container mx-auto px-6 lg:px-8 text-center">
          <motion.div {...fadeUp}>
            ...
            <h2 className="text-3xl md:text-5xl font-black leading-tight mb-6"
              style={{ color: 'var(--heading)', letterSpacing: '-0.04em' }}>
              Ready to Hire Your<br />Swift iOS Developer?
            </h2>
            <p className="text-lg mb-10 max-w-2xl mx-auto" style={{ color: 'var(--muted-foreground)' }}>
              Share your project requirements today. We&apos;ll match you with pre-vetted Swift developer profiles within 48 hours.
            </p>
