...
/* ─── data ────────────────────────────────────────────────────────── */
const heroStats = [
  { value: 1000, suffix: '+', label: 'Systems Delivered' },
  { value: 16,   suffix: '+', label: 'Years Experience' },
  { value: 220,  suffix: '+', label: 'Python Developers' },
  { value: 95,   suffix: '+', label: 'Certified Experts' },
];

const heroBullets = [
  'Build robust web backends, secure APIs, and custom scraping solutions with Python experts.',
  'Vetted for MVC architectures (Django/Flask), modern APIs (FastAPI), and Data Analytics (Pandas).',
  'Hire pre-vetted cloud-integrated engineers for full-time, part-time, or hourly engagements.',
  'ReapMind: Sourcing and onboarding top 1% Python talent in India.',
];
...
const whyUs = [
  ...
  { icon: Users,      title: 'Flexibility & Retention',  description: 'Scale your Python engineering squad up or down based on your roadmap cycles.' },
  ...
  { icon: Star,       title: 'Top 1% Vetted Talent',     description: 'A 5-stage assessment covering Python OOPs, system architecture, database locks, and performance.' },
];

const techStack = [
  { label: 'Core / Language',     items: ['Python'] },
  { label: 'Web Frameworks',     items: ['Django', 'Flask', 'FastAPI'] },
  { label: 'Data Science & ML',   items: ['Pandas', 'NumPy', 'Scikit-Learn', 'TensorFlow', 'PyTorch'] },
  { label: 'Databases & Ops',     items: ['SQL', 'NoSQL', 'CI-CD'] },
  { label: 'Cloud Deployment',    items: ['AWS', 'Azure', 'GCP'] },
];
...
const hiringModels = [
  { title: 'Full Time',    icon: Clock,    hours: '8 hrs / day',    commitment: '160 hrs / month', highlight: true,  description: 'Deep integration and full daily focus on your Python backend systems.' },
  { title: 'Part Time',    icon: Zap,      hours: '4 hrs / day',    commitment: '60 hrs / month',  highlight: false, description: 'Ongoing support, SDK upgrades, database migrations, or feature optimizations.' },
  { title: 'Hourly Basis', icon: RefreshCw,hours: 'Open hrs / day', commitment: '50 hrs minimum',  highlight: false, description: 'Short-scope consultations, API debugging, or scraping setup fixes with no lock-in.' },
];

const developerTiers = [
  { level: 'Junior Python Developer',    exp: '1–3 Years Experienced', priceRange: '$1,000 – $1,300' },
  { level: 'Mid Level Python Developer', exp: '3–5 Years Experienced', priceRange: '$1,400 – $1,900' },
  { level: 'Senior Python Developer',    exp: '5+ Years Experienced',  priceRange: '$2,000 – $2,800' },
];
...
const faqs = [
  { q: "What types of Python projects do your developers specialize in?", a: "Our Python developers have expertise in a wide range of applications: Web Development (Django, Flask, FastAPI), Data Science / ML (Pandas, NumPy, Scikit-learn, TensorFlow, PyTorch), Scripting & Automation, and Backend APIs." },
  { q: "What is the typical experience level of your Python developers?", a: "We offer access to a diverse pool of talent, ranging from junior developers with a strong foundation in Python to senior engineers with years of experience and specialized expertise." },
  { q: "How do you ensure the quality of your Python developers?", a: "We have a rigorous vetting process that includes technical assessments, code reviews, and interviews to evaluate each developer's skills, experience, and problem-solving abilities." },
  { q: "How can I get started with hiring a Python developer from your company?", a: "Simply contact us through our website or email, and we'll schedule a consultation to discuss your project requirements. We'll then provide a curated list of developers for you to select from." },
];
...
export default function HirePythonDevelopersPage() {
  ...
  return (
    <div className="overflow-x-hidden">
        ...
        <div className="relative container mx-auto px-6 lg:px-8 py-36 lg:py-44 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h1 className="text-5xl md:text-6xl lg:text-[4.25rem] font-black leading-[1.02] mb-7"
              ...
              {['Python Rockstars,', 'Ready to Roll with', 'ReapMind.'].map((word, i) => (
                <motion.span key={word} className="block"
                  initial={{ opacity: 0, x: -32 }} animate={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.55, delay: 0.1 + i * 0.12, ease: [0.22, 1, 0.36, 1] }}>
                  {i === 2 ? <><span style={{ color: 'var(--brand-blue)' }}>ReapMind</span>{' Python.'}</> : word}
                </motion.span>
              ))}
            </h1>
            ...
            <motion.p className="text-[1.05rem] leading-[1.75] mb-8 max-w-lg"
              ...
              Need Python experts who can build anything? ReapMind&apos;s premium Python developers utilize the newest tools and libraries to craft innovative, top-notch solutions.
            </motion.p>
      ...
      {/* ══ HIRE FORM ════════════════════════════════════════════════ */}
      <HireAndroidForm devRole="Python Developer" image="/images/python/python-developers.png" />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <motion.div {...fadeLeft} className="lg:sticky lg:top-32">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-black leading-tight mb-6"
                ...
                Python Developers, Ready to<br />Roll with ReapMind
              </h2>
              <p className="text-lg leading-relaxed mb-8" style={{ color: 'var(--muted-foreground)' }}>
                As a premium Python development company, our skilled developers utilize the newest technologies and tools to craft innovative, top-notch solutions. Build lightning-fast backends and leverage modern data frameworks with absolute cost control.
              </p>
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <p className="font-black text-sm" style={{ color: 'var(--heading)' }}>Backend &amp; Data Engineering</p>
                  <p className="text-xs" style={{ color: 'var(--muted-foreground)' }}>REST/GraphQL APIs, web scrapers, automated workflows, ML modeling, and cloud deployments</p>
                </div>
              </div>
              <div className="relative rounded-2xl overflow-hidden h-52">
                <Image src="/images/company-workspace.png" alt="Python backend engineering team" fill className="object-cover" />
      ...
      <section className="py-20 md:py-32" style={{ background: 'var(--section-tint)' }}>
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading
            ...
            description="Our Python experts write reliable server logic, design flexible database models, and build high-performance data workflows."
            className="mb-14"
          />
              ...
              <div key={cat.label}>
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  {cat.items.map((tech, ti) => {
                    ...
                    const imgSrc = `/images/python/${imgName}`;
                    return (
                      <motion.div key={tech}
      ...
      <section className="py-20 md:py-32 bg-background">
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading
            badge="How It Works"
            title="Hire Python Developers in 4 Simple Steps"
            description="Take a look at the simple & straightforward process to hire Python developers from ReapMind Innovations."
            className="mb-16"
          />
          <div className="grid lg:grid-cols-2 gap-16 items-center max-w-5xl mx-auto">
            {/* image with floating badge */}
            <motion.div {...fadeLeft} className="relative rounded-3xl overflow-hidden h-96 lg:h-[480px]">
              <Image src="/images/svc-mobile-2.jpg" alt="Python Developers at ReapMind" fill className="object-cover" />
              ...
              <div className="absolute top-6 left-6 flex items-center gap-3 px-4 py-3 rounded-2xl section-card">
                ...
                <span className="text-xs font-bold" style={{ color: 'var(--heading)' }}>Actively matching Python developers</span>
              </div>
              <div className="absolute bottom-6 left-6 right-6">
                <div className="section-card rounded-2xl px-5 py-4 flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-black" style={{ color: 'var(--heading)' }}>Top 1% Python Talent</p>
                    <p className="text-xs" style={{ color: 'var(--muted-foreground)' }}>Vetted on backend latency, Django architectural patterns, and Pandas optimization</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <motion.div {...fadeUp}
            ...
            <div className="relative">
              <h3 className="text-xl font-black mb-2" style={{ color: 'var(--heading)' }}>
                Want to build high-performance Python application?
              </h3>
              <p className="text-sm" style={{ color: 'var(--muted-foreground)' }}>
                ReapMind delivers qualified Python developers to scale your operations immediately.
              </p>
            </div>
      ...
      <section id="models" className="py-20 md:py-32" style={{ background: 'var(--section-tint)' }}>
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading
            ...
            description="Build your dream Python application on a budget. Our flexible engagement models ensure you get the expertise you need at a price that works for you."
            className="mb-14"
          />
      ...
      <section className="py-20 md:py-32 bg-background">
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading
            ...
            title="Scale Your Team with Top-Tier Python Developers"
            description="ReapMind's expert Python developers accelerate your web development timelines without compromising quality."
            className="mb-14"
          />
          <div className="grid sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
      ...
      <section className="py-20 md:py-32 bg-background">
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading badge="Industries We Serve" title="Python Apps Across Every Sector" className="mb-14" />
      ...
      <section className="py-20 md:py-32" style={{ background: 'var(--section-tint)' }}>
        <div className="container mx-auto px-6 lg:px-8">
          <SectionHeading badge="FAQ" title="Frequently Asked Questions"
            description="Everything you need to know before hiring your Python developer from ReapMind."
            className="mb-14" />
        ...
        <div className="relative container mx-auto px-6 lg:px-8 text-center">
          <motion.div {...fadeUp}>
            ...
            <h2 className="text-3xl md:text-5xl font-black leading-tight mb-6"
              style={{ color: 'var(--heading)', letterSpacing: '-0.04em' }}>
              Ready to Hire Your<br />Python Developer?
            </h2>
            <p className="text-lg mb-10 max-w-2xl mx-auto" style={{ color: 'var(--muted-foreground)' }}>
              Share your project requirements today. We&apos;ll match you with pre-vetted Python developer profiles within 48 hours.
            </p>
            <div className="flex flex-wrap gap-4 justify-center mb-14">
              <a href="#blur-target" className="btn-primary px-8 py-4 text-base inline-flex items-center gap-2">
