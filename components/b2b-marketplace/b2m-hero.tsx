...
const HUB_NODES = [
  { id: "buyers", label: "Buyers", sub: "Wholesale demand", x: "10%", y: "20%" },
  { id: "platform", label: "Platform", sub: "B2B hub", x: "40%", y: "50%" },
  { id: "sellers", label: "Vendors", sub: "Global listings", x: "72%", y: "18%" },
  { id: "logistics", label: "Logistics", sub: "Track & fulfill", x: "68%", y: "68%" },
] as const;

export function B2mHero() {
  const { hero } = b2bMarketplaceConfig;
  ...
  return (
    <section className="relative overflow-hidden bg-surface-dark pb-12 pt-10 text-primary-foreground md:pb-14 md:pt-12 lg:pt-14">
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_18%_0%,rgba(26,105,253,0.26),transparent_55%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_55%_45%_at_90%_25%,rgba(139,92,246,0.15),transparent)]" />
      </div>
      ...
      <div className="container-app relative">
        <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.95fr)] lg:gap-12">
          <div>
            ...
            <div className="mt-3">
              <HeroWordHeading text={hero.heading} accentWord="B2B" />
            </div>
          ...
          >
            <div className="relative aspect-[4/3] overflow-hidden rounded-[1.75rem] border border-white/10 bg-black/50 backdrop-blur-sm">
              <svg className="absolute inset-0 h-full w-full" aria-hidden>
                <motion.line x1="22%" y1="28%" x2="46%" y2="54%" stroke="rgba(26,105,253,0.5)" strokeWidth="1.5" initial={{ pathLength: 0, opacity: 0 }} animate={{ pathLength: 1, opacity: 1 }} transition={{ delay: 0.5, duration: 1.2, ease: smoothEase }} />
                <motion.line x1="78%" y1="24%" x2="52%" y2="54%" stroke="rgba(139,92,246,0.5)" strokeWidth="1.5" initial={{ pathLength: 0, opacity: 0 }} animate={{ pathLength: 1, opacity: 1 }} transition={{ delay: 0.65, duration: 1.2, ease: smoothEase }} />
                <motion.line x1="52%" y1="58%" x2="74%" y2="72%" stroke="rgba(16,185,129,0.5)" strokeWidth="1.5" initial={{ pathLength: 0, opacity: 0 }} animate={{ pathLength: 1, opacity: 1 }} transition={{ delay: 0.8, duration: 1.2, ease: smoothEase }} />
              </svg>
