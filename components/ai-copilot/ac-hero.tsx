        ...
        <div className="grid items-start gap-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.9fr)] lg:gap-10">
          ...
          <FadeIn delay={0.08}>
            <div className="space-y-4">
              <GaiNeuralVisual className="hidden h-36 rounded-2xl border border-border-strong sm:block lg:h-44" />
              <div className="rounded-[1.5rem] border border-border-strong bg-surface-elevated p-5 sm:p-6">
                ...
                <p className="mt-2 text-sm text-white/60">
                  Free consultation within 24 hours — tell us about your copilot project.
                </p>
                <div className="mt-5">
