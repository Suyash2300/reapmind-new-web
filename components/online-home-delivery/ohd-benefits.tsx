...
const ACCENTS = ["#F97316", "#1A69FD", "#10B981", "#8B5CF6"] as const;

export function OhdBenefits() {
  const { benefits } = onlineHomeDeliveryConfig;
  const reducedMotion = usePrefersReducedMotion();

  return (
    <section className="border-t border-white/10 bg-black py-12 md:py-16 lg:py-20" aria-labelledby="ohd-benefits-heading">
      <div className="container-app">
        <BlurFadeIn as="h2" id="ohd-benefits-heading" className="max-w-3xl text-h3 font-bold text-white sm:text-h2">
          {benefits.title}
        </BlurFadeIn>
