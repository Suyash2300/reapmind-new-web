...
export function VdxEngagement() {
  const { engagement } = vueDevelopmentConfig;
  ...
  return (
    <section className="border-t border-white/10 bg-surface-dark py-12 md:py-16 lg:py-20" aria-labelledby="vdx-engagement-heading">
      <div className="container-app">
        <BlurFadeIn as="h2" id="vdx-engagement-heading" className="mx-auto max-w-4xl text-center text-h3 font-bold text-white sm:text-h2">
          {engagement.title}
        </BlurFadeIn>
