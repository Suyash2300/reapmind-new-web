...
export function EbsPortfolioCta() {
  const reducedMotion = usePrefersReducedMotion();

  return (
    <div className="relative overflow-hidden border-t border-white/10 bg-surface-dark py-10">
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,transparent,rgba(26,105,253,0.06),transparent)]" aria-hidden />
      <div className="container-app relative text-center">
        <BlurFadeIn>
          ...
          >
            ...
            >
              {ecommerceBusinessConfig.portfolioCta}
            </Link>
          </motion.div>
        </BlurFadeIn>
      </div>
