...
export function EbsPlatformIntro() {
  const { platform } = ecommerceBusinessConfig;
  ...
  return (
    <section
      ...
      aria-labelledby="ebs-platform-heading"
    >
      ...
      <div className="container-app relative">
        <div className="grid gap-12 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.75fr)] lg:items-start lg:gap-16">
          <div>
            <BlurFadeIn as="h2" id="ebs-platform-heading" className="max-w-3xl text-h3 font-bold text-white sm:text-h2">
              {platform.title}
            </BlurFadeIn>
          ...
          <div className="space-y-4">
            {platform.stats.map((stat, i) => (
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-primary/10 to-transparent opacity-0 transition-opacity group-hover:opacity-100" aria-hidden />
            ...
            >
              <Image
                src="/generative-ai/mobile-payment.png"
                alt="Mobile payment and checkout experience"
                fill
