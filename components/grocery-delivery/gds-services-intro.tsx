...
export function GdsServicesIntro() {
  const { services } = groceryDeliveryConfig;
  const reducedMotion = usePrefersReducedMotion();

  return (
    <section className="border-t border-white/10 bg-black py-12 md:py-16" aria-labelledby="gds-services-heading">
      <div className="container-app">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,280px)] lg:items-start lg:gap-14">
          <div>
            <BlurFadeIn as="h2" id="gds-services-heading" className="max-w-3xl text-h3 font-bold text-white sm:text-h2">
              {services.title}
            </BlurFadeIn>
