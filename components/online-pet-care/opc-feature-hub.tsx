...
export function OpcFeatureHub() {
  const { features } = onlinePetCareConfig;
  ...
  return (
    <section className="border-t border-white/10 bg-surface-dark py-12 md:py-16 lg:py-20" aria-labelledby="opc-features-heading">
      <div className="container-app">
        <BlurFadeIn as="h2" id="opc-features-heading" className="mx-auto max-w-4xl text-center text-h3 font-bold text-white sm:text-h2">
          {features.title}
        </BlurFadeIn>

        <div className="mt-10 grid gap-6 lg:grid-cols-[minmax(0,240px)_minmax(0,1fr)] lg:items-stretch">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="relative">
                ...
                {!reducedMotion && (
                  <motion.div className="mt-8 h-1 overflow-hidden rounded-full bg-white/10" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}>
                    <motion.div
