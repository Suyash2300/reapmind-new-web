...
export function OpcWhyReapmind() {
  const { whyUs } = onlinePetCareConfig;
  const reducedMotion = usePrefersReducedMotion();
  const [innovation, commitment, quality] = whyUs.items;

  return (
    <section className="border-t border-white/10 bg-black py-12 md:py-16 lg:py-20" aria-labelledby="opc-why-heading">
      <div className="container-app">
        <BlurFadeIn as="h2" id="opc-why-heading" className="max-w-4xl text-h3 font-bold text-white sm:text-h2">
          {whyUs.title}
        </BlurFadeIn>
