...
export function RdxIndustries() {
  const { industries } = reactDevelopmentConfig;
  const reducedMotion = usePrefersReducedMotion();

  return (
    <section className="border-t border-white/10 bg-black py-12 md:py-16 lg:py-20" aria-labelledby="rdx-industries-heading">
      <div className="container-app">
        <BlurFadeIn as="h2" id="rdx-industries-heading" className="max-w-4xl text-h3 font-bold text-white sm:text-h2">
          {industries.title}
        </BlurFadeIn>
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-2">
          {industries.items.map((item, i) => (
            <motion.span
              ...
              whileHover={reducedMotion ? undefined : { scale: 1.05, borderColor: "rgba(97,218,251,0.4)" }}
