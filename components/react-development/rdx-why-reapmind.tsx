...
export function RdxWhyReapmind() {
  const { whyUs } = reactDevelopmentConfig;
  const reducedMotion = usePrefersReducedMotion();

  return (
    <section className="border-t border-white/10 bg-surface-dark py-12 md:py-16 lg:py-20" aria-labelledby="rdx-why-heading">
      <div className="container-app">
        <BlurFadeIn as="h2" id="rdx-why-heading" className="max-w-4xl text-h3 font-bold text-white sm:text-h2">
          {whyUs.title}
        </BlurFadeIn>
