...
export function RdxEngagement() {
  const { engagement } = reactDevelopmentConfig;
  ...
  return (
    <section className="border-t border-white/10 bg-surface-dark py-12 md:py-16 lg:py-20" aria-labelledby="rdx-engagement-heading">
      <div className="container-app">
        <BlurFadeIn as="h2" id="rdx-engagement-heading" className="mx-auto max-w-4xl text-center text-h3 font-bold text-white sm:text-h2">
          {engagement.title}
        </BlurFadeIn>
