...
export function OmdClientLogos() {
  const reduced = usePrefersReducedMotion();
  const logos = [...omdConfig.clientLogos.logos, ...omdConfig.clientLogos.logos];

  return (
    <section className="section-app overflow-hidden border-y border-white/10 bg-surface-header py-16">
      <div className="container-app">
        <h2 className="mx-auto max-w-4xl text-center text-h3 font-bold text-white">{omdConfig.clientLogos.title}</h2>
      </div>
