      ...
      <div className="container-app">
        ...
        <div className="mt-20 grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
          ...
          <div className="flex flex-col gap-3">
            {productDesignConfig.services.map((service, i) => (
          ...
          <div className="sticky top-28 hidden lg:block">
            <div className="relative h-[560px] rounded-3xl overflow-hidden ring-1 ring-white/10">
              <AnimatePresence mode="wait">
                ...
                >
                  <Image
                    src={productDesignConfig.services[active].image}
                    alt={productDesignConfig.services[active].title}
                    fill
                  ...
                  >
                    <span className="text-sm font-bold uppercase tracking-widest text-primary">
                      0{active + 1} / 0{productDesignConfig.services.length}
                    </span>
                    <p className="mt-1 text-h3 font-bold text-white">
                      {productDesignConfig.services[active].title}
                    </p>
                  </motion.div>
                </motion.div>
              </AnimatePresence>
