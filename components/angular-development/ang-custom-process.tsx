...
export function AngCustomProcess() {
  const { customProcess } = angularDevelopmentConfig;
  const reducedMotion = usePrefersReducedMotion();

  return (
    <section className="border-t border-white/10 bg-black py-12 md:py-16 lg:py-20" aria-labelledby="ang-process-heading">
      <div className="container-app">
        <BlurFadeIn as="h2" id="ang-process-heading" className="max-w-4xl text-h3 font-bold text-white sm:text-h2">
          {customProcess.title}
        </BlurFadeIn>
        ...
        <BlurFadeIn delay={0.12} className="mt-12 rounded-[1.75rem] border border-[#DD0031]/20 bg-gradient-to-br from-[#DD0031]/8 via-black to-primary/5 p-6 sm:p-8">
          ...
          >
            <Link
              ...
              className="inline-flex min-h-11 items-center justify-center rounded-full bg-[#DD0031] px-8 text-sm font-semibold text-white transition-colors hover:bg-[#c4002b]"
            >
