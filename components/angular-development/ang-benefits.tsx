...
export function AngBenefits() {
  const { benefits } = angularDevelopmentConfig;
  const reducedMotion = usePrefersReducedMotion();

  return (
    <section className="border-t border-white/10 bg-black py-12 md:py-16 lg:py-20" aria-labelledby="ang-benefits-heading">
      <div className="container-app">
        <BlurFadeIn as="h2" id="ang-benefits-heading" className="mx-auto max-w-4xl text-center text-h3 font-bold text-white sm:text-h2">
          {benefits.title}
        </BlurFadeIn>
