...
export function NftReputableIntro() {
  const { reputableIntro } = nftMarketplaceConfig;
      ...
      <div className="container-app">
        <FadeIn>
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-h3 font-bold text-white sm:text-h2">{reputableIntro.title}</h2>
            {reputableIntro.paragraphs.map((paragraph) => (
              <p
