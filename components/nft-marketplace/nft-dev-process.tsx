...
export function NftDevProcess() {
  const { devProcess } = nftMarketplaceConfig;
  ...
  return (
    <section
      ...
      aria-labelledby="nft-dev-process-heading"
    >
      <div className="container-app">
        <FadeIn>
          <h2 id="nft-dev-process-heading" className="max-w-4xl text-h3 font-bold text-white sm:text-h2">
            {devProcess.title}
          </h2>
        </FadeIn>
