...
export function NftWhyUs() {
  const { whyUs } = nftMarketplaceConfig;

  return (
    <section
      className="border-t border-white/10 bg-surface-dark py-10 text-primary-foreground md:py-12 lg:py-14"
      aria-labelledby="nft-why-us-heading"
    >
      <div className="container-app">
        <FadeIn>
          <h2 id="nft-why-us-heading" className="max-w-4xl text-h3 font-bold text-white sm:text-h2">
            {whyUs.title}
          </h2>
        </FadeIn>
