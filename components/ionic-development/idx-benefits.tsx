...
export function IdxBenefits() {
  const { benefits } = ionicDevelopmentConfig;
  const reducedMotion = usePrefersReducedMotion();

  return (
    <section className="border-t border-white/10 bg-black py-12 md:py-16 lg:py-20" aria-labelledby="idx-benefits-heading">
      <div className="container-app">
        <BlurFadeIn as="h2" id="idx-benefits-heading" className="mx-auto max-w-4xl text-center text-h3 font-bold text-white sm:text-h2">
          {benefits.title}
        </BlurFadeIn>
