...
export function NdxIndustries() {
  const { industries } = nextjsDevelopmentConfig;
  const reducedMotion = usePrefersReducedMotion();

  return (
    <section className="border-t border-white/10 bg-black py-12 md:py-16 lg:py-20" aria-labelledby="ndx-industries-heading">
      <div className="container-app">
        <BlurFadeIn as="h2" id="ndx-industries-heading" className="max-w-4xl text-h3 font-bold text-white sm:text-h2">
          {industries.title}
        </BlurFadeIn>
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-2">
          {industries.items.map((item, i) => (
            <motion.span
              ...
              whileHover={reducedMotion ? undefined : { scale: 1.05, borderColor: "rgba(255,255,255,0.35)" }}
