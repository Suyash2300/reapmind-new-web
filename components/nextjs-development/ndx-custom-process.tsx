...
export function NdxCustomProcess() {
  const { customProcess } = nextjsDevelopmentConfig;
  const reducedMotion = usePrefersReducedMotion();

  return (
    <section className="border-t border-white/10 bg-black py-12 md:py-16 lg:py-20" aria-labelledby="ndx-process-heading">
      <div className="container-app">
        <BlurFadeIn as="h2" id="ndx-process-heading" className="max-w-4xl text-h3 font-bold text-white sm:text-h2">
          {customProcess.title}
        </BlurFadeIn>
        ...
        >
          ...
          >
            <Link
              ...
              className="inline-flex min-h-11 items-center justify-center rounded-full bg-white px-8 text-sm font-semibold text-black transition-opacity hover:opacity-90"
            >
