...
export function SuHero() {
  const { hero } = startupConfig;
  ...
  return (
    <section className="relative overflow-hidden bg-surface-dark pb-10 pt-10 text-primary-foreground md:pb-12 md:pt-12 lg:pt-14">
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_70%_55%_at_75%_0%,rgba(26,105,253,0.2),transparent)]" />
      </div>
          ...
          <FadeIn delay={0.08}>
            <div className="rounded-[1.5rem] border border-border-strong bg-surface-elevated p-5 sm:p-6">
              ...
              <p className="mt-2 text-sm text-white/60">
                Free consultation within 24 hours — tell us about your startup idea.
              </p>
              <div className="mt-5">
