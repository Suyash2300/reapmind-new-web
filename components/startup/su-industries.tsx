...
export function SuIndustries() {
  ...
  return (
    <section
      ...
      aria-labelledby="su-industries-heading"
    >
      <div className="container-app">
        <FadeIn>
          <h2 id="su-industries-heading" className="text-h3 font-bold text-white sm:text-h2">
            {industries.title}
          </h2>
          <p className="mt-4 max-w-3xl text-para text-white/60">{industries.intro}</p>
        </FadeIn>
