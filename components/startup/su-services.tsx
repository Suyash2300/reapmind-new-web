...
export function SuServices() {
  const { services } = startupConfig;
  ...
  return (
    <section
      ...
      aria-labelledby="su-services-heading"
    >
      <div className="container-app">
        <FadeIn>
          <h2 id="su-services-heading" className="text-h3 font-bold text-white sm:text-h2">
            {services.title}
          </h2>
        </FadeIn>
