...
export function VpaWhyReapmind() {
  const { whyUs } = valetParkingAppConfig;
  ...
  return (
    <section
      ...
      aria-labelledby="vpa-why-heading"
    >
      <div className="container-app">
        <BlurFadeIn as="h2" id="vpa-why-heading" className="max-w-4xl text-h3 font-bold text-white sm:text-h2">
          {whyUs.title}
        </BlurFadeIn>
