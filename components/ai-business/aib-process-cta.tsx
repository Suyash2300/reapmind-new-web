...
export function AibProcessCta() {
  const { process } = aiBusinessConfig;
    ...
    <section className="border-t border-white/10 bg-surface-dark py-10 md:py-12" aria-label="Process call to action">
      <div className="container-app">
        <motion.div
          ...
          style={{
            background: `linear-gradient(135deg, ${AI_ACCENT}14, black, ${AI_CYAN}0a)`,
          }}
        >
          <BlurFadeIn as="p" className="text-sm font-semibold uppercase tracking-wider text-violet-400">
            {process.tagline}
          </BlurFadeIn>
          <Link
