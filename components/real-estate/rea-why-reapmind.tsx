...
export function ReaWhyReapmind() {
  const { whyUs } = realEstateConfig;
  const reducedMotion = usePrefersReducedMotion();
  const [tech, agile, partnerships, global, pricing, caseStudies] = whyUs.items;

  return (
    <section className="border-t border-white/10 bg-black py-12 md:py-16 lg:py-20" aria-labelledby="rea-why-heading">
      <div className="container-app">
        <BlurFadeIn as="h2" id="rea-why-heading" className="max-w-4xl text-h3 font-bold text-white sm:text-h2">
          {whyUs.title}
        </BlurFadeIn>
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.05fr)] lg:grid-rows-3 lg:items-stretch lg:gap-6">
          <BlurFadeIn delay={0.02} className="h-full lg:col-start-1 lg:row-start-1">
            <PillarCard {...tech} reducedMotion={reducedMotion} />
          </BlurFadeIn>
          ...
          <BlurFadeIn delay={0.06} className="h-full lg:col-start-1 lg:row-start-3">
            <PillarCard {...partnerships} reducedMotion={reducedMotion} />
          </BlurFadeIn>
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <BlurFadeIn delay={0.08}>
            <PillarCard {...global} reducedMotion={reducedMotion} />
          </BlurFadeIn>
          <BlurFadeIn delay={0.1}>
            <PillarCard {...pricing} reducedMotion={reducedMotion} />
          </BlurFadeIn>
          <BlurFadeIn delay={0.12} className="sm:col-span-2 lg:col-span-1">
            <PillarCard {...caseStudies} reducedMotion={reducedMotion} />
          </BlurFadeIn>
        </div>
