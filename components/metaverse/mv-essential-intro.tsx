...
export function MvEssentialIntro() {
  const { essentialIntro } = metaverseConfig;
      ...
      <div className="container-app">
        <FadeIn>
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-h3 font-bold text-white sm:text-h2">{essentialIntro.title}</h2>
            {essentialIntro.paragraphs.map((paragraph) => (
              <p
