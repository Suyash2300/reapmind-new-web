...
export function EmProcess() {
  ...
  return (
    <section ref={containerRef} className="section-app bg-black py-32 relative">
      <div className="container-app">
        <GsapScrollReveal className="max-w-4xl mb-24">
          <span className="text-primary font-bold tracking-widest uppercase text-sm block mb-4">
            {enterpriseMobilityConfig.process.title}
          </span>
          <h2 className="text-display font-black text-white leading-tight">
            {enterpriseMobilityConfig.process.subtitle}
          </h2>
        </GsapScrollReveal>
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="space-y-16 md:space-y-32">
            {enterpriseMobilityConfig.process.steps.map((step, i) => {
              const isEven = i % 2 === 0;
              return (
                <div key={step.step} className="relative flex flex-col md:flex-row items-center md:justify-between group">
                  {/* Timeline Dot */}
