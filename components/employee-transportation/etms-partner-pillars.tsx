...
export function EtmsPartnerPillars() {
  const { partner } = employeeTransportationConfig;
  const reducedMotion = usePrefersReducedMotion();

  return (
    <section className="border-t border-white/10 bg-surface-dark py-12 md:py-16" aria-labelledby="etms-partner-heading">
      <div className="container-app">
        <BlurFadeIn as="h2" id="etms-partner-heading" className="mx-auto max-w-4xl text-center text-h3 font-bold text-white sm:text-h2">
          {partner.title}
        </BlurFadeIn>
