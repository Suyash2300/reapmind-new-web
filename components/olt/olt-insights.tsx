...
export function OltInsights() {
  const reduced = usePrefersReducedMotion();
  const articles = oltConfig.insights.articles;

  return (
    <section className="section-app border-t border-white/8 bg-[#0a0f1a] py-20 sm:py-24">
      <div className="container-app">
        <div className="mb-8 flex flex-wrap items-end justify-between gap-4">
          <h2 className="text-h2 font-black text-white md:text-display">{oltConfig.insights.title}</h2>
          <Link
            href="/blogs"
