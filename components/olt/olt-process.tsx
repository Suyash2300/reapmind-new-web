    ...
    <section ref={ref} className="section-app bg-black py-20 sm:py-24">
      <div className="container-app">
        <h2 className="mx-auto max-w-4xl text-center text-h2 font-black text-white md:text-display">
          {oltConfig.process.title}
        </h2>
        <p className="mx-auto mt-5 max-w-3xl text-center text-para text-white/70">{oltConfig.process.subtitle}</p>
        ...
        <div className="relative mx-auto mt-14 max-w-lg">
          ...
          <div className="space-y-5">
            {oltConfig.process.steps.map((step, index) => (
              <motion.div
                key={step}
        ...
        <p className="mx-auto mt-10 max-w-2xl text-center text-sm text-white/60">{oltConfig.process.tagline}</p>
