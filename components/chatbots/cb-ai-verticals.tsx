...
export function CbAiVerticals() {
  ...
  const [activeId, setActiveId] = useState(aiVerticals.items[0].id);
  const active =
    aiVerticals.items.find((item) => item.id === activeId) ?? aiVerticals.items[0];
  ...
  return (
    ...
    >
      <div className="container-app">
        <FadeIn>
          <h2 id="cb-ai-verticals-heading" className="text-h3 font-bold text-white sm:text-h2">
            {aiVerticals.title}
          </h2>
        </FadeIn>
              ...
              >
                ...
                <div className="p-6 sm:p-7">
                  ...
                  <Link
                    ...
                    className="mt-6 inline-flex min-h-11 items-center justify-center rounded-full bg-primary px-7 text-sm font-semibold text-white transition-colors hover:bg-primary-hover"
                  >
                    Contact Us
                  </Link>
                </div>
