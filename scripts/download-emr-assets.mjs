...
const ASSETS = [
  ["hero-banner.png", "https://reapmind.com/wp-content/uploads/2025/03/banner-1.png"],
  ["feature-banner-2.png", "https://reapmind.com/wp-content/uploads/2025/03/banner-2.png"],
...
const dir = path.join("public", "emr");
