...
const url = "https://reapmind.com/professional-networking-platform/";
const publicDir = path.join(__dirname, "..", "public", "professional-networking");
...
for (const raw of unique) {
  ...
  mapping[safeName] = `/professional-networking/${safeName}`;
}
