...
export const homeTechPlatforms = {
  ...
  subtitle:
    "Production-grade tools across the full software lifecycle — languages, frameworks, cloud, data, DevOps, and AI development.",
  autoPlayMs: 5500,
  categories: [
    {
      id: "languages",
    ...
    },
    {
      ...
      tagline: "LLMs, agents, ML frameworks, and MLOps for intelligent products",
      accentClass: "text-fuchsia-400",
      borderClass: "border-fuchsia-400/40 shadow-[0_0_32px_-8px_rgba(217,70,239,0.35)]",
      items: [
        { id: "openai", name: "OpenAI", icon: "openai", color: "412991" },
        { id: "claude", name: "Claude", icon: "claude", color: "D97757" },
        { id: "cursor", name: "Cursor", icon: "cursor", color: "FFFFFF" },
        { id: "copilot", name: "GitHub Copilot", icon: "githubcopilot", color: "FFFFFF" },
        { id: "google-gemini", name: "Gemini", icon: "googlegemini", color: "8E75B2" },
        { id: "langchain", name: "LangChain", icon: "langchain", color: "1C3C3C" },
        { id: "huggingface", name: "Hugging Face", icon: "huggingface", color: "FFD21E" },
        { id: "ollama", name: "Ollama", icon: "ollama", color: "FFFFFF" },
        { id: "tensorflow", name: "TensorFlow", icon: "tensorflow", color: "FF6F00" },
        { id: "pytorch", name: "PyTorch", icon: "pytorch", color: "EE4C2C" },
        { id: "scikitlearn", name: "scikit-learn", icon: "scikitlearn", color: "F7931E" },
        { id: "opencv", name: "OpenCV", icon: "opencv", color: "5C3EE8" },
        { id: "jupyter", name: "Jupyter", icon: "jupyter", color: "F37626" },
        { id: "mlflow", name: "MLflow", icon: "mlflow", color: "0194E2" },
        { id: "nvidia", name: "NVIDIA CUDA", icon: "nvidia", color: "76B900" },
      ],
    },
